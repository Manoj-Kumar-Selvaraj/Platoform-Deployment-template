...
# This deploys the chart with a placeholder image — first real image
# is pushed by Jenkins pipeline. Set deploy_sample_app = true after
# you've pushed an image to ECR.
